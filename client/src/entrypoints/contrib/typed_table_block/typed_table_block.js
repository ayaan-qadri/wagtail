...
export class TypedTableBlock {
  ...
  insertColumn(index, blockDef, opts) {
    ...
    const prependColumnButton = $(`<button type="button"></button>`)
      .html(`<svg class="icon icon-plus icon" aria-hidden="true"><use href="#icon-plus"></use></svg>`)
      .addClass('button button-secondary button-small button--icon text-replace prepend-column')
